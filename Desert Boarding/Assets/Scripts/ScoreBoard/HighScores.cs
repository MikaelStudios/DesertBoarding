...
{
    const string privateCode = "KMpUS5QU1Uu46dw4C4L54gbkio3DS61kO1uixYMOr4rQ";  //Key to Upload New Info
    const string publicCode = "63249cb38f40bb0fe8cbfa71";   //Key to download
